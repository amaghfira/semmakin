                ...
                <div class="row">
                    <div class="col-sm-6">
                        <fieldset>
                            ...
                            <input type="hidden" name="disposisi" id="disposisi">
                            <div class="form-group">
                                <!-- <textarea name="disposisi" rows="5" class="form-control" id="disposisi" placeholder="Masukkan nama orang"></textarea> -->
                                <div class="multiselect">
                                    ...
                                    <div id="checkboxes" onclick="myFunc()">
                                        <?php foreach ($pegawai as $p) : ?>
                                            <label><input type="checkbox" name="check" value="<?= $p['nama']; ?>" /><?= $p['nama']; ?></label>
                                        <?php endforeach; ?>
                            ...
                            <script>
                                ...
                                function myFunc() {
                                    ...
                                    document.getElementById("disposisi").innerHTML = arr.toString();
