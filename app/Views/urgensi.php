...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Urgensi Naskah</h1>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover" id="tabel-master">
                ...
                <tbody>
                    <?php if ($urgensi) : ?>
                        <?php foreach ($urgensi as $j) : ?>
                            <tr>
                                <td><?php echo $j['id']; ?></td>
                                <td><?php echo $j['urgensi']; ?></td>
                                <td>
                                    <a href="#" class="btn btn-info btn-sm btn-edit" data-id="<?= $j['id']; ?>" data-urgensi="<?= $j['urgensi']; ?>">Edit</a>
...
<!-- Modal Add Product-->
<form action="<?= base_url() ?>/urgensi/add" method="post">
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambahkan Urgensi</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>urgensi</label>
                        <input type="text" class="form-control" name="urgensi_baru" placeholder="Masukkan urgensi" required>
                    </div>
                </div>
...
<!-- Modal edit form -->
<form action="<?= base_url() ?>/urgensi/edit" method="post">
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Master urgensi</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<!-- Modal delete form -->
<form action="<?= base_url(); ?>/urgensi/delete" method="post">
