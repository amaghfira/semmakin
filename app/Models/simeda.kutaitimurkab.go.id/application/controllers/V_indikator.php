...
class V_indikator extends CI_Controller {
	...
	public function index()
	{
		$this->load->view('template', array(
			'_title'=> 'Verifikasi Metadata Indikator',
			'_breadcrumbs'=>array('Verifikasi', 'Indikator'),
	...
	public function get_checklist()
	{
		...
		if($this->input->post('id_ms_keg') && $this->input->post('id_indikator')){
			...
			$return['message'] = 'Data tidak ditemukan'.serialize($this->input->post());
