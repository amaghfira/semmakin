...
<blockquote class="box box-success">
    ...
    <div class="box-footer">
  	    <div>
  	    	" Metadata Indikator dalam kuesioner ini telah melalui proses pemeriksaan oleh <b>BPS Provinsi</b> dan siap untuk dilanjutkan ke proses berikutnya. "
  	    </div>
        <div class="checkbox pull-left" style="margin-top:0; margin-bottom:0">
          <label>
            <input type="checkbox" name="cek_ind" style="height: 24px" <?php if($cek_provinsi && $cek_provinsi->cek_ind) echo 'checked';?>> Approval Indikator
          </label>
        </div>
