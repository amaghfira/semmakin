...
<div class="box box-info">
	<div class="box-body">
		<div class="form-group">
			...
			<div class="col-sm-1">
				<input class="form-control align-center" multi-item approval="" blok="vi" id="metode_pemeriksaan_kualitas_pengumpulan_data" name="blok_vi[metode_pemeriksaan_kualitas_pengumpulan_data]" value="<?=$blok_vi->metode_pemeriksaan_kualitas_pengumpulan_data;?>" autofocus>
			</div>
			<div class="col-sm-4 col-sm-offset-1">
				...
				<input class="form-control" placeholder="(Lainnya) Sebutkan" approval="" blok="vi" id="metode_pemeriksaan_kualitas_pengumpulan_data_lainnya" name="blok_vi[metode_pemeriksaan_kualitas_pengumpulan_data_lainnya]" value="<?=$blok_vi->metode_pemeriksaan_kualitas_pengumpulan_data_lainnya;?>">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-1">
				<input class="form-control align-center" list-item approval="" blok="vi" id="apakah_melakukan_penyesuaian_nonrespon" name="blok_vi[apakah_melakukan_penyesuaian_nonrespon]" value="<?=$blok_vi->apakah_melakukan_penyesuaian_nonrespon;?>">
			</div>
			<div class="col-sm-4 col-sm-offset-1">
	...
	<div class="box-body">
		<div class="form-group">
			...
			<div class="col-sm-1">
				<input class="form-control align-center" list-item approval="" blok="vi" id="petugas_pengumpulan_data" name="blok_vi[petugas_pengumpulan_data]" value="<?=$blok_vi->petugas_pengumpulan_data;?>">
			</div>
			<div class="col-sm-4 col-sm-offset-1">
		...
		<div class="form-group">
			...
			<div class="col-sm-1">
				<input class="form-control align-center" list-item approval="" blok="vi" id="persyaratan_pendidikan_terendah_petugas_pengumpulan_data" name="blok_vi[persyaratan_pendidikan_terendah_petugas_pengumpulan_data]" value="<?=$blok_vi->persyaratan_pendidikan_terendah_petugas_pengumpulan_data;?>">
			</div>
			<div class="col-sm-4 col-sm-offset-1">
		...
		<div class="form-group">
			...
			<div class="col-sm-2"> 
				<div class="input-group">
					<input type="text" class="form-control" approval="" blok="vi" id="jumlah_petugas_supervisor" name="blok_vi[jumlah_petugas_supervisor]" value="<?=$blok_vi->jumlah_petugas_supervisor;?>">
			...
			<div class="col-sm-2"> 
				<div class="input-group">
					<input type="text" class="form-control" approval="" blok="vi" id="jumlah_petugas_enumerator" name="blok_vi[jumlah_petugas_enumerator]" value="<?=$blok_vi->jumlah_petugas_enumerator;?>">
				    <span class="input-group-addon"><i class="fa fa-user"></i></span>
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-1">
				<input class="form-control align-center" list-item approval="" blok="vi" id="apakah_melakukan_pelatihan_petugas" name="blok_vi[apakah_melakukan_pelatihan_petugas]" value="<?=$blok_vi->apakah_melakukan_pelatihan_petugas;?>">
			</div>
			<div class="col-sm-4 col-sm-offset-1">
				<li>Ya <span class="pull-right">- 1</span></li>
				<li>Tidak <span class="pull-right">- 2</span></li>
	...
	<div class="box-body">
		...
		<div class="row">
			...
			<div class="col-sm-1"><input class="form-control align-center input-sm" approval="" blok="vii" id="tahapan_pengolahan_data_editing" name="blok_vii[tahapan_pengolahan_data_editing]" value="<?=$blok_vii->tahapan_pengolahan_data_editing;?>"></div>
		</div>
		<div class="row">
			<div class="col-sm-4 col-sm-offset-1">Penyandian (Coding)</div>
			<div class="col-sm-2">Ya - 1 <span class="pull-right">Tidak - 2</span></div>			
			<div class="col-sm-1"><input class="form-control align-center input-sm" approval="" blok="vii" id="tahapan_pengolahan_data_coding" name="blok_vii[tahapan_pengolahan_data_coding]" value="<?=$blok_vii->tahapan_pengolahan_data_coding;?>"></div>
		</div>
		<div class="row">
			<div class="col-sm-4 col-sm-offset-1">Data Entry</div>
			<div class="col-sm-2">Ya - 1 <span class="pull-right">Tidak - 2</span></div>			
			<div class="col-sm-1"><input class="form-control align-center input-sm" approval="" blok="vii" id="tahapan_pengolahan_data_entry" name="blok_vii[tahapan_pengolahan_data_entry]" value="<?=$blok_vii->tahapan_pengolahan_data_entry;?>"></div>
		</div>
		<div class="row">
			<div class="col-sm-4 col-sm-offset-1">Penyahihan (Validasi)</div>
			<div class="col-sm-2">Ya - 1 <span class="pull-right">Tidak - 2</span></div>			
			<div class="col-sm-1"><input class="form-control align-center input-sm" approval="" blok="vii" id="tahapan_pengolahan_data_validasi" name="blok_vii[tahapan_pengolahan_data_validasi]" value="<?=$blok_vii->tahapan_pengolahan_data_validasi;?>"></div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-1">
				<input class="form-control align-center" list-item approval="" blok="vii" id="metode_analisis" name="blok_vii[metode_analisis]" value="<?=$blok_vii->metode_analisis;?>">
			</div>			
			<div class="col-sm-4 col-sm-offset-1">
