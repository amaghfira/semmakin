...
$('#pilih_wilayah').change(function(){
   location.href = "<?=base_url('report/pertanyaan');?>/"+$(this).val(); 
});
<?php } ?>

$('#pilih_instansi').change(function(){
   location.href = "<?=base_url('report/pertanyaan/'.$id_wilayah);?>/"+$(this).val(); 
});  

<?php if($id_wilayah && $id_instansi) { ?>
$('#pilih_kegiatan').change(function(){
   location.href = "<?=base_url('report/pertanyaan/'.$id_wilayah.'/'.$id_instansi);?>/"+$(this).val(); 
});  
<?php } ?>
</script>